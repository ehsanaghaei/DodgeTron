...
if __name__ == "__main__":
    ...
    final_embedding = get_malware_embeddings(representations, model, tokenizer, cls_embedding=True, mean_pooling=True, max_size=512, overlap_size=100, load_representations=True, load_embeddings=True, device=device)
